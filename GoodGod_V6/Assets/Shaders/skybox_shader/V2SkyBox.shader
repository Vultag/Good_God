Shader "Shader Graphs/V3Stylized_Skybox 1"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
        {
            ...
            float2 _Property_cc2309cfafa843efb973cde45999464b_Out_0 = _Vector2;
            float2 _TilingAndOffset_5178df25d09b4f74b0a9b1d835dbdd09_Out_3;
            Unity_TilingAndOffset_float((_Normalize_102866732eac4470b5a5548826e2896d_Out_1.xy), float2 (1, 1), _Property_cc2309cfafa843efb973cde45999464b_Out_0, _TilingAndOffset_5178df25d09b4f74b0a9b1d835dbdd09_Out_3);
